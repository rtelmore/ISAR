#' NHL's Colorado Avalanche Player Statistics
#'
#' A dataset containing the statistics for all Colorado Avalanche players on the 2022-23 roster
#'
#' @format A data frame with 162 rows and 50 variables:
#' \describe{
