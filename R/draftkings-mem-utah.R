#' Draftkings Showdown Game (Grizzlies vs. Jazz)
#'
#' A dataset containing the Draftkings salary information for Game 4 of the
#'  2021 NBA Playoffs between the Memphis Grizzlies and Utah Jazz.
#'
