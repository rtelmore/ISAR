#' Draftkings Showdown Game in NHL (New York Rangers versus Carolina Hurricanes)
#'
#' A dataset containing the Draftkings salary information for Game 7 of the
#'  2022 NHL Playoffs between the New York Rangers and Carolina Hurricanes.
#'
