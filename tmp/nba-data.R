...
games <- hoopR::nba_leaguegamelog(season = "2022-23",
                                  season_type = "Regular Season")

games <- readRDS("tmp/nba-games-end-2023.rds")
df <- dplyr::as_tibble(games$LeagueGameLog) |>
  janitor::clean_names()

saveRDS(df, "tmp/nba-games-end-2023.rds")
games <- readRDS("data/nba-games-end-2023.rds")
...
saveRDS(results, "tmp/four-factors-box-600-2023.rds")
...
saveRDS(results, "tmp/four-factors-box-601-1200-2023.rds")
...
saveRDS(results, "tmp/four-factors-box-1201-1230-2023.rds")
...
saveRDS(results, "tmp/advanced-box-600-2023.rds")
...
saveRDS(results, "tmp/advanced-box-601-1200-2023.rds")
...
saveRDS(results, "tmp/advanced-box-1201-1230-2023.rds")
...
saveRDS(results, "tmp/misc-box-600-2023.rds")
...
saveRDS(results, "tmp/misc-box-601-1200-2023.rds")
...
saveRDS(results, "tmp/misc-box-1201-1230-2023.rds")


misc_list <- c(readRDS("tmp/misc-box-600-2023.rds"),
               readRDS("tmp/misc-box-601-1200-2023.rds"),
               readRDS("tmp/misc-box-1201-1230-2023.rds"))
saveRDS(misc_list, "tmp/misc-box-2023.rds")

adv_list <- c(readRDS("tmp/advanced-box-600-2023.rds"),
              readRDS("tmp/advanced-box-601-1200-2023.rds"),
              readRDS("tmp/advanced-box-1201-1230-2023.rds"))
saveRDS(adv_list, "tmp/adv-box-2023.rds")

ff_list <- c(readRDS("tmp/four-factors-box-600-2023.rds"),
             readRDS("tmp/four-factors-box-601-1200-2023.rds"),
             readRDS("tmp/four-factors-box-1201-1230-2023.rds"))
saveRDS(ff_list, "tmp/ff-box-2023.rds")

df_tmp <- readRDS("tmp/ff-box-2023.rds")

df <- do.call(rbind,
              lapply(df_tmp, FUN = function(x) x$sqlTeamsFourFactors)) %>%
  janitor::clean_names()

saveRDS(df, "tmp/ff-team-2023.rds")

df_tmp <- readRDS("tmp/adv-box-2023.rds")

df <- do.call(rbind,
              lapply(df_tmp, FUN = function(x) x$TeamStats)) %>%
  janitor::clean_names()

saveRDS(df, "tmp/adv-team-2023.rds")

df_tmp <- readRDS("tmp/misc-box-2023.rds")

df <- do.call(rbind,
              lapply(df_tmp, FUN = function(x) x$sqlTeamsMisc)) %>%
  janitor::clean_names()

saveRDS(df, "data/misc-team-2023.rds")
...
games <- nbastatR::game_logs(seasons = 2023,
                             league = "NBA",
                             result_types = "team")

saveRDS(games, "data/nba-games-end-2023.rds")
...
saveRDS(ff, "data/four-factors-team-end-2023.rds")
...
#adv_2 <- distinct(adv)
saveRDS(adv, file = "data/advanced-team-end-2023.rds")
...
saveRDS(adv, file = "data/misc-team-end-2023.rds")
...
df_a <- readRDS("data/advanced-team-end-2023.rds")
df_g <- readRDS("data/nba-games-end-2023.rds")
df_ff <- readRDS("data/four-factors-team-end-2023.rds")
...
df <- dplyr::bind_rows(
  ...
  nbastatR::teams_shots(teams = "Denver Nuggets", seasons = 2023))
